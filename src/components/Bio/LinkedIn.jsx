function BioLinkedIn({ onClose }) {
  return (
    <div className="border-2 border-blue-400 rounded-xl p-6 w-[450px] h-[500px] relative ">
      ...
      <h2 className="font-bold text-lg mb-4 text-blue-300">LinkedIn Profile</h2>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-sm font-thin">LinkedIn</p>
        </div>
      </div>
      ...
      <div className="mt-4">
        ...
        <p className="text-sm text-white bg-[#1b2a3f] p-5 rounded-lg">
          Cyber Security with 1+ years of experience in web development and
          cloud technologies.
        </p>
      </div>
      ...
      <div className="mt-5">
        ...
        <div className="grid grid-cols-3 gap-2 text-center text-sm">
          ...
          <div className="bg-[#0d1117] border border-gray-700 rounded p-2">
            <p className="font-bold text-blue-400">631</p>
