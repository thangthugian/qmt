function BioSpotify({ onClose }) {
  return (
    <div className="border-2 border-blue-400 rounded-xl p-6 w-[450px] h-[500px] relative ">
      ...
      <h2 className="font-bold text-lg mb-4 text-blue-300">Spotify Profile</h2>
      ...
      <div className="flex items-center space-x-4">
        ...
        />
        <div>
          <h3 className="text-lg font-semibold text-blue-300">chubedan</h3>
      ...
      <div className="mt-4">
        ...
        <p className="text-sm text-white bg-[#1b2a3f] p-5 rounded-lg">
          Check out my playlists and favorite music. I listen to a variety of
          genres while coding!
        </p>
      </div>
      ...
      <div className="mt-5">
        ...
        <div className="grid grid-cols-3 gap-2 text-center text-sm">
          <div className="bg-[#0d1117] border border-gray-700 rounded p-2">
            <p className="font-bold text-blue-400">22</p>
            <p className=" font-thin">repositories</p>
          </div>
          <div className="bg-[#0d1117] border border-gray-700 rounded p-2">
            <p className="font-bold  text-blue-400">208</p>
            <p className=" font-thin">followers</p>
          </div>
          <div className="bg-[#0d1117] border border-gray-700 rounded p-2">
            <p className="font-bold  text-blue-400">8</p>
      ...
      <div className="mt-7 flex justify-end">
        ...
        >
          <a href="https://open.spotify.com/user/31pp2nryjnr2lin7nnkfssgarxqa">
            visit
          </a>
        </button>
      </div>
